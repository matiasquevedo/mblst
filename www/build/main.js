...
var ItinerarioPage = (function () {
    ...
    ItinerarioPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-itinerario',template:/*ion-inline-start:"/var/www/html/mblst/src/pages/itinerario/itinerario.html"*/`<!--\n  Generated template for the ItinerarioPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>itinerario</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n`/*ion-inline-end:"/var/www/html/mblst/src/pages/itinerario/itinerario.html"*/,
        }),
...
var HomePage = (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/var/www/html/mblst/src/pages/home/home.html"*/`<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Embalsa</ion-title>\n    \n  </ion-navbar> \n  <shrinking-segment-header [scrollArea]="myContent" headerHeight="100">\n        <div class="presentacion" text-center>\n          	<div text-center><button ion-button round>Nuevo Itinerario</button></div>	\n        </div>\n   </shrinking-segment-header> \n</ion-header>\n\n<ion-content padding #myContent>\n\n  <!-- <ion-fab right bottom>\n    <button style="background-color: #016648; color:w" ion-fab (click)="itinerario()"><ion-icon ios="ios-add" md="md-add"></ion-icon></button>\n  </ion-fab>  -->\n  \n\n  <div class="conferencias">\n    <h3>Valle Grande</h3>\n    <p>Información, paquetes, itinerario</p>\n  </div>\n\n  <div class="talleres">\n    <h3>Cañon del Atuel</h3>\n  </div>  \n\n <div class="social">\n    <h3>Los Reyunos</h3>\n  </div>\n</ion-content>\n`/*ion-inline-end:"/var/www/html/mblst/src/pages/home/home.html"*/,
        }),
...
var ListPage = (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"/var/www/html/mblst/src/pages/list/list.html"*/`<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n`/*ion-inline-end:"/var/www/html/mblst/src/pages/list/list.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]])
    ], ListPage);
    return ListPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_shrinking_segment_header_shrinking_segment_header__ = __webpack_require__(275);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__components_shrinking_segment_header_shrinking_segment_header__["a" /* ShrinkingSegmentHeader */]
            ],
            imports: [
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/var/www/html/mblst/src/app/app.html"*/`<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>`/*ion-inline-end:"/var/www/html/mblst/src/app/app.html"*/
        }),
...
var ShrinkingSegmentHeader = (function () {
    ...
    ShrinkingSegmentHeader = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'shrinking-segment-header',template:/*ion-inline-start:"/var/www/html/mblst/src/components/shrinking-segment-header/shrinking-segment-header.html"*/`<!-- Generated template for the ShrinkingSegmentHeaderComponent component -->\n<ng-content>\n	\n</ng-content>`/*ion-inline-end:"/var/www/html/mblst/src/components/shrinking-segment-header/shrinking-segment-header.html"*/
        }),
